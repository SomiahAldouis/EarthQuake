    ...
    private class QuakeHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        fun setMag(mag: Double) {
            magView.apply {
                ...
                when {
                    mag < 2.0 -> setBackgroundResource(R.drawable.mag_shap_low)
                    mag < 3.0 -> setBackgroundResource(R.drawable.mag_shap_med)
                    mag <= 4.0 -> setBackgroundResource(R.drawable.mag_shap_med2)
                    mag in 5.0..10.0 -> setBackgroundResource(R.drawable.mag_shap_high)
                }
            }
        }
